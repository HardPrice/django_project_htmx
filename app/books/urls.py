...
urlpatterns = [
    ...
    path(_('update_book_details/<int:pk>/'), update_book_details,
    ...
    path(_('update_book_status/<int:pk>/'), cache_page(600)(update_book_status), 
         name='update_book_status'),
    path(_('book_list_sort/<filter>/<direction>/'), book_list_sort, 
         name='book_list_sort')
]
